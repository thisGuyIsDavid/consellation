...
class ConstellationsFinder:
    ...
    def __init__(self, store_to_examine: StorePoint, constellations: typing.List[Constellation], store_list: typing.List[StorePoint], store_lookup: KDTree):
    ...
    def process_constellation(self, constellation: Constellation):
        ...
        for store_to_test in self.store_list:
            ...
            discovered_constellation = ConstellationFinder(
                ...
                minimum_projected_size=minimum_constellation_size,
